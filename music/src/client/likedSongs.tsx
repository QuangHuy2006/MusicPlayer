    ...
    <div className="p-6 md:p-10 animate-[fade-in_0.5s_ease-out]">
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            <h2 className="text-3xl font-bold text-white tracking-tight">Bài hát yêu thích</h2>
            <p className="text-slate-400 mt-1">{songs.length} bài hát</p>
          </div>
        </div>

        {songs.length === 0 ? (
          <div className="text-center py-20 bg-slate-900/30 rounded-3xl border border-slate-800/50 backdrop-blur-sm">
            <FaHeart className="text-6xl text-slate-700 mx-auto mb-4" />
            <h3 className="text-xl font-bold text-slate-300">Chưa có bài hát yêu thích</h3>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 pr-4">
                    <h3 className={`text-base font-bold truncate transition-colors ${isActive ? 'text-pink-400' : 'text-slate-200 group-hover:text-white'}`}>
                      {song.name}
                    </h3>
