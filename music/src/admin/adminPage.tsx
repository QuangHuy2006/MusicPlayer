...
import { 
  FaCheckCircle, FaCheck, FaTimes, FaUser, FaIdBadge, 
  FaExclamationTriangle, FaChartBar, FaMusic, FaUsers, 
  FaBan, FaUnlock, FaArrowUp, FaArrowDown, FaPlus
} from "react-icons/fa";
                   ...
                   <div className="mt-6">
                      {user.role !== 'ADMIN' && (
                        <button 
                          ...
                          className={`w-full py-3 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2 ${
                            user.isBanned 
